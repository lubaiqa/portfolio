...
//             <button
//               type="submit"
//               className="px-6 py-2.5 rounded-lg font-semibold text-white bg-gradient-to-br from-blue-500 to-indigo-600 shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 transition-shadow"
//             >
//               Send message
//             </button>
//           </form>
